...
/// 
/// The left and right objects should be childed under the respective HandAnchor's. If the line is glitchy or detects things differently due to its animations, a different 
/// rayCastPosition should be chosen.
/// </summary>
